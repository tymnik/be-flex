    ...
    en: {
      translation: {
        ...
        aboutMe: {
          ...
          text: `Welcome to my digital space! I'm Anastasia, a dedicated and passionate gymnastics coach with over seven years of experience in nurturing young talents. My journey began at`,
          text2: `the youthful age of 16, marking the start of a rewarding career filled with growth, learning, and joy. At 23, I reflect on these years with immense pride, having had the privilege of coaching in diverse cultural settings across Ukraine, Turkey, Kuwait, and Dubai.`,
          text3: `Since 2021, Dubai has been my coaching home — a city that resonates with my love for gymnastics, offering unparalleled opportunities and facilities. My expertise lies in guiding children from the tender age of four,fostering their skills, confidence, and love for the sport. I take immense pride in leading a team of competitive young gymnasts. Together, we have journeyed through numerous competitions in Dubai, Abu-Dhabi, and beyond celebrating a multitude of victories and accolades.`,
          text4: `Join me in exploring the world of gymnastics, where every leap is a step towards greatness.`,
