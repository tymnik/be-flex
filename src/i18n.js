    ...
    uk: {
      translation: {
        ...
        'youWillFind':{
          ...
          'card1text':'Особисте (приватне) заняття - це унікальна можливість для гімнастки працювати індивідуально з тренером. Завдяки особистм заняттям з тренером дитина набагато краще та успішніше розвивається, швидше опановує нові навички та краще виконує вправи.',
        ...
        'training':{
          ...
          'mainTxt':'Тренування йдуть від простих до складних, бо кожен простий елемент поступово стає складним, навчання завжди починається з базових прав на виконання ідеальної техніки, якщо ваша дитина має досвід, я його покращу',
        },
        'toTake':{
        ...
        'faq':{
          ...
          'a1':'Пробне заняття — це 30-хвилинна приватна сесія, щоб познайомитися із тренером і розробили план навчання.',
          ...
          <br>Початківцям і маленьким дітям треба займатися 1-2 рази щотижня по 1 годині.`,
